...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Entrada de Stock</li>
@endsection
...
<div class="container-fluid py-4">
    <div class="row align-items-center mb-4">
        <div class="col-lg-8">
            <h2 class="mb-2">
                <i class="fas fa-dolly text-success me-2"></i>
                Registrar Entrada de Stock
            </h2>
            <p class="text-muted mb-0">
                Incrementa el inventario de un producto y deja el movimiento registrado en el historial auditable.
            </p>
        </div>
        ...
        <div class="col-xl-7 col-lg-8">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom">
                    <h5 class="mb-0">
                        <i class="fas fa-clipboard-check text-success me-2"></i>Datos de la entrada
                    </h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.stock-entries.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-4">
                            <label for="motivo" class="form-label fw-bold">Motivo / Nota (Opcional)</label>
                            <textarea
                                id="motivo"
                                name="motivo"
                                ...
                                rows="3"
                                maxlength="255"
                                placeholder="Ej: Recepción de mercadería, reposición semanal, ajuste por conteo"
                            >{{ old('motivo') }}</textarea>
                            @error('motivo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
