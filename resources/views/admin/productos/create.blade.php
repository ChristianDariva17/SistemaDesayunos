    ...
    <div class="row mb-4">
        <div class="col-lg-12">
            <div class="d-flex align-items-center mb-3">
                ...
                <div>
                    <h2 class="mb-1">Crear Nuevo Producto</h2>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            >
                                ...
                                <option value="comidas" {{ old('categoria') == 'comidas' ? 'selected' : '' }}>
                                    🍽️ Comidas
                                </option>
                                <option value="bebidas" {{ old('categoria') == 'bebidas' ? 'selected' : '' }}>
                                    🥤 Bebidas
                                </option>
                                <option value="postres" {{ old('categoria') == 'postres' ? 'selected' : '' }}>
                                    🍰 Postres
                                </option>
                                <option value="snacks" {{ old('categoria') == 'snacks' ? 'selected' : '' }}>
                                    🍿 Snacks
                                </option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                @else
                                    <small class="text-muted">
                                        <i class="fas fa-lightbulb me-1"></i>
                                        Opcional - código interno del producto
                                    </small>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="text-center mb-3">
                            ...
                            >
                                <div id="placeholderImagen">
                                    ...
                                    <h6 class="text-muted mb-2">Arrastra y suelta tu imagen aquí</h6>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2">
                            <div class="form-check-card">
                                ...
                                <label class="form-check-label w-100" for="estado_activo">
                                    <div class="card border estado-card {{ old('estado', 'activo') == 'activo' ? 'border-success bg-success bg-opacity-10' : '' }}">
                                        <div class="card-body p-3">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <i class="fas fa-circle-check text-success {{ old('estado', 'activo') == 'activo' ? '' : 'd-none' }}"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-check-card">
                                ...
                                <label class="form-check-label w-100" for="estado_inactivo">
                                    <div class="card border estado-card {{ old('estado') == 'inactivo' ? 'border-danger bg-danger bg-opacity-10' : '' }}">
                                        <div class="card-body p-3">
                                            <div class="d-flex align-items-center">
                                                <div class="me-3">
                                                ...
                                                <div>
                                                    <i class="fas fa-circle-check text-danger {{ old('estado') == 'inactivo' ? '' : 'd-none' }}"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        @else
                            <small class="text-muted d-block mt-2">
                                <i class="fas fa-lightbulb me-1"></i>
                                Los productos activos son visibles en el catálogo
                            </small>
                        @enderror
                    </div>
                </div>
                ...
                <div class="card border-0 bg-info bg-opacity-10 shadow-sm">
                    <div class="card-body">
                        ...
                        <ul class="small mb-0 ps-3">
                            <li class="mb-1">Los campos con <span class="text-danger">*</span> son obligatorios</li>
                            <li class="mb-1">Usa nombres descriptivos y claros</li>
                            <li class="mb-1">La imagen ayuda a identificar el producto</li>
                            <li class="mb-1">Puedes editar esta información después</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <small class="text-muted">
                                    <i class="fas fa-info-circle me-1"></i>
                                    Todos los cambios se guardarán inmediatamente
                                </small>
                            </div>
                            <div class="btn-group" role="group">
                                <a href="{{ route('admin.productos.index') }}" class="btn btn-lg btn-outline-secondary">
                                    <i class="fas fa-times me-2"></i>
                                    Cancelar
                                </a>
                                <button type="reset" class="btn btn-lg btn-outline-warning">
                                    <i class="fas fa-undo me-2"></i>
                                    Limpiar
                                </button>
                                <button type="submit" class="btn btn-lg btn-primary" id="btnGuardar">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('btnGenerarSKU').addEventListener('click', function() {
        ...
        // Generar SKU: primeras letras nombre + categoría + timestamp
