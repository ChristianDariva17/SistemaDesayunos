...
<div class="max-w-lg mx-auto p-6 bg-white shadow-md rounded-lg">
    <h2 class="text-xl font-bold mb-6 text-gray-800">Registrar Producto</h2>
    ...
    <form action="{{ route('productos.store') }}" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <textarea name="descripcion" id="descripcion"
                      class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none">{{ old('descripcion') }}</textarea>
        </div>
